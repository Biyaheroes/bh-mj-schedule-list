...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./schedule-list.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "schedule-list",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "schedule-list.deploy.js"
		},
